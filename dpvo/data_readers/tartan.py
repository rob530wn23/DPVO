...
test_split = [
    # "abandonedfactory/abandonedfactory/Easy/P011",   # fog
    ...
    # "endofworld/endofworld/Easy/P009",               # snow and fog
    ...
    # "seasonsforest/seasonsforest/Easy/P011",       # falling leaves
    ...
    # "soulcity/soulcity/Easy/P012",                # rain
...
class TartanAir(RGBDDataset):
    ...
    def _build_dataset(self):
        ...
        for scene in tqdm(sorted(scenes)):
            ...
            # translation are scaled by 5.0
            poses[:,:3] /= TartanAir.DEPTH_SCALE
            # Why is intrinsics have only 4 values
